...
for envs in "ZE_AFFINITY_MASK=0.0" \
 ...
 #"LIBOMPTARGET_LEVEL_ZERO_USE_IMMEDIATE_COMMAND_LIST=1" #"ZE_AFFINITY_MASK=1.0" "LIBOMPTARGET_LEVEL_ZERO_COMMAND_BATCH=copy" "LIBOMPTARGET_LEVEL0_USE_COPY_ENGINE=all" "CFESingleSliceDispatchCCSMode=1"
do
    (
    export $envs
